...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // 애니메이션
        waitRunRatio = Mathf.Lerp(waitRunRatio, 0, 10 * Time.deltaTime);
        Animator anime = GetComponent<Animator>();
        anime.SetFloat("Wait_run_ratio", waitRunRatio);
        anime.Play("WAIT_RUN");
    }
    ...
    private void UpdateMoving()
    {
        ...
        // 이동 애니메이션
        waitRunRatio = Mathf.Lerp(waitRunRatio, 1, 10 * Time.deltaTime);
        Animator anime = GetComponent<Animator>();
        anime.SetFloat("Wait_run_ratio", waitRunRatio);
        anime.Play("WAIT_RUN");
    }
